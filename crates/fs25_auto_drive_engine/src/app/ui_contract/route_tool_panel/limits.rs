...
/// Eingabegrenzen fuer die Abtast-Schrittweite des Verrundungs-Tools.
pub const ROUNDING_SAMPLE_SPACING_LIMITS: FloatInputLimits = FloatInputLimits::new(0.5, 50.0);
