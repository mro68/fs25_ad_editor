...
//! Drag verschieben, Apex B(0.5) draggbar — Enter bestaetigt.
//!
//! **Tangenten-Auswahl:** Rechtsklick im Viewport oeffnet Kontextmenue mit
...
//! nur entlang der Tangenten-Linie (ermoeglicht auch S-Kurven hinter dem Anker).
//!
//! **Asymmetrisches Biegen:** Wenn beide Tangenten fixiert sind, loest der Apex-Drag
//! ein 2×2-Gleichungssystem — die Kurve biegt sich asymmetrisch unter Einhaltung
//! beider Tangenten-Richtungen.
//!
//! Grad wird ueber das Dropdown in der Toolbar umgeschaltet.
//!
//! Aufgeteilt in:
...
//! - `config_ui`  — Properties-Panel + Tangenten-Kontextmenue
