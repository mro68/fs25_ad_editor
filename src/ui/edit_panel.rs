...
/// Erzeugt ein lesbares Label fuer einen Node (ID + Position).
///
/// Gibt "Keine" zurueck wenn `node_id` None ist, sonst "#ID (x, y)" wenn
/// die Position in der RoadMap bekannt ist, oder "#ID" falls nicht.
