...
- [x] **Flutter-Backend Phase 1: Control-Plane API (2026-04-08)**
  ...
  - [x] Direkte Flutter-C-FFI-Paritaet fuer FRB-Removal hergestellt: `lib.rs` exportiert die komplette `fs25ad_flutter_session_*`-Surface (Actions/Dialog-Requests, 13 Read-Snapshots, Shared-Arc acquire/release) additiv fuer `dart:ffi`/`ffigen`; Header-, API- und FFI-Tests synchron
