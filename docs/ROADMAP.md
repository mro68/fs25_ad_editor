...
- [x] **RouteOffsetTool — Strecke Versetzen (2026-03-07)**
  ...
  - [x] Einbahn-Verhalten fuer beidseitigen Versatz: linke/rechte Spur werden automatisch gegensaetzlich erzeugt; Button `Links/Rechts Verkehr` schaltet die Spurzuordnung um (nur bei Einbahn + links/rechts aktiv)
...
- [ ] Performance-Optimierung
  ...
  - [x] Tool-Preview: Degree-basierte Knoten-Groesse fuer Preview-Nodes vereinheitlicht (2026-04-24) — Knoten mit `degree != 2` werden mit 3x Durchmesser gerendert; `degree == 0` bleibt Control-Point-Diamant
